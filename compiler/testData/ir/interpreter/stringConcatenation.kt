...
const val concat10 = "String plus example with A class: " <!EVALUATED: `String plus example with A class: toString call from A class`!>+ A()<!>
const val concat11 = "String plus example with B class, where toString is FAKE_OVERRIDDEN: " <!EVALUATED: `String plus example with B class, where toString is FAKE_OVERRIDDEN: toString call from A class`!>+ B()<!>
